...
import "common_tool/pkg/webbase"
...
func (p *DemoActionParser) SaveJSON(subp any) error {
...
func init() {
	...
	webbase.RegisterHelp("DemoAction", helpStr)
	// 注册解析器(传入指针)
	webbase.RegisterParser(&DemoActionParser{})
}